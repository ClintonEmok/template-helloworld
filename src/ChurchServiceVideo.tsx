...
import { ChurchWelcome, ScriptureScene, LocationScene, ChurchOutro, AnnouncementSlide, DetailedServiceScene } from './ChurchServiceScenes';

export const ChurchServiceVideo: React.FC<{
  churchName: string;
}> = ({ churchName }) => {
  return (
    <Series>
