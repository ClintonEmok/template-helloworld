...
export const ThesisIntro: React.FC<{ title: string; subtitle: string }> = ({
  title,
  subtitle,
}) => {
...
export const UIComponentShowcase: React.FC<{
  ...
  return (
    <AbsoluteFill
      style={{ backgroundColor: BG_COLOR, fontFamily, padding: 80 }}
    >
      <div
        style={{
          display: "grid",
...
export const DynamicFormUI: React.FC = () => {
  ...
  return (
    ...
    >
      {[0, 1, 2].map((i) => {
        const op = interpolate(frame - i * 10, [0, 20], [0, 1], {
