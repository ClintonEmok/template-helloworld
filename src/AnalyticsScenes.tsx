    ...
    >
      ...
      >
        ...
        >
          ...
          <br />
          with <span style={{ color: ACCENT }}>Space-Time Cubes</span>
        </h1>
        <p
          style={{
            fontSize: 24,
        ...
        >
          Visualizing complex spatio-temporal data through dynamic temporal
          resolution and 3D projection.
        </p>
        <div
          style={{
            marginTop: 50,
...
const LineChart: React.FC<{ color: string; delay: number }> = ({
  color,
  delay,
}) => {
  const frame = useCurrentFrame();
...
export const ToolLayout: React.FC = () => {
  ...
  return (
    <AbsoluteFill
      style={{ backgroundColor: "#020617", fontFamily, padding: 40 }}
    >
      {/* Header */}
      <div
        style={{
          ...
          padding: "0 20px",
          color: "white",
          opacity: layoutEntrance,
        }}
      >
        <div style={{ fontWeight: 800, fontSize: 20, color: ACCENT }}>STC</div>
        <div style={{ marginLeft: 20, fontSize: 14, color: "#64748b" }}>
          Adaptive_Scaling_Analysis_v1.0
        </div>
        <div style={{ flex: 1 }} />
        <div
          style={{
        ...
        >
          ...
          <div
            style={{
              ...
              position: "relative",
              perspective: "1000px",
              transform: `rotateX(45deg) rotateY(${frame * 0.5}deg)`,
          ...
          >
            ...
            {/* Mock Data Points in Cube (Y is up/down now) */}
            {[1, 2, 3, 4, 5].map((i) => (
              <div
                key={i}
                style={{
                  ...
                  background: ACCENT,
                  borderRadius: "50%",
                  // Moving up in Y (height) as time
                  transform: `translate3d(${20 + Math.sin(frame / 20 + i) * 60}px, ${-50 + i * 40}px, ${Math.cos(frame / 20 + i) * 60}px)`,
        ...
        >
          ...
          <div
            style={{
              ...
              width: 4,
              background: ACCENT,
              left: `${interpolate(frame % 300, [0, 300], [0, 100])}%`,
        ...
        >
          ...
          <div
            style={{
              ...
              width: 4,
              background: "#10b981",
              left: `${interpolate((frame + 100) % 300, [0, 300], [0, 100])}%`,
